                            ...
                            <div class="user-chat-info">
                                ...
                                <div class="contact-meta">
                                    ...
                                    @if($chat->notification)
                                        <span class="badge badge-primary badge-pill float-right notification_count">{{ $chat->notification }}</span>
                                    @else
                                        <div class="counter" hidden>
                                            <span class="badge badge-primary badge-pill float-right notification_count"></span>
                                        </div>
                                    @endif
