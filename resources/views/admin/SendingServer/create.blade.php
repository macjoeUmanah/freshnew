                            ...
                            <div class="card-body">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        @if($server['settings'] == 'ClickatellTouch' || $server['settings'] == 'ClickatellCentral' || $server['settings'] == 'TextLocal' || $server['settings'] == 'Vonage' || $server['settings'] == 'MessageBird' || $server['settings'] == 'Tyntec' || $server['settings'] == 'Telnyx' || $server['settings'] == 'Infobip' || $server['settings'] == 'BroadcasterMobile' || $server['settings'] == 'BeemAfrica' || $server['settings'] == 'ElitBuzzBD' || $server['settings'] == 'HablameV2' || $server['settings'] == 'ZamtelCoZm' || $server['settings'] == 'CellCast' || $server['settings'] == 'AfricasTalking' || $server['settings'] == 'SpoofSend' || $server['settings'] == 'AlhajSms' || $server['settings'] == 'SendroidUltimate' || $server['settings'] == 'RealSMS' || $server['settings'] == 'LTR' || $server['settings'] == 'SmartVision' || $server['settings'] == 'ZipComIo')
                                        ...
                                        @if($server['settings'] == 'Bulksmsplans')
                                            ...
                                            <div class="col-12">
                                                <fieldset class="form-group">
                                                    <label class="required" for="route">SMS Type</label>
                                        ...
                                        @if($server['settings'] == 'Vonage' || $server['settings'] == 'Bandwidth' || $server['settings'] == 'BeemAfrica' || $server['settings'] == 'Skyetel')
                                        ...
                                        @if($server['settings'] == 'PitchWink')
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label class="required" for="c1">Credential</label>
                                                    <input type="text" id="c1" class="form-control @error('c1') is-invalid @enderror" value="{{ $server['c1'] }}" name="c1" required>
                                                    @error('c1')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                        ...
                                        @if($server['settings'] == 'Solucoesdigitais')
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label class="required" for="c1">Centro custo interno</label>
                                                    <input type="text" id="c1" class="form-control @error('c1') is-invalid @enderror" value="{{ $server['c1'] }}" name="c1" required>
                                                    @error('c1')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                        ...
                                        @if($server['settings'] == 'Wavy')
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label class="required" for="auth_token">Authentication Token</label>
                                                    <input type="text" id="auth_token" class="form-control @error('auth_token') is-invalid @enderror" value="{{ $server['auth_token'] }}" name="auth_token" required>
                                                    @error('auth_token')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                        ...
                                        @if($server['settings'] == 'SmsGatewayMe' || $server['settings'] == 'WhatsAppChatApi' || $server['settings'] == 'SignalWire' || $server['settings'] == 'Bandwidth' || $server['settings'] == 'BroadcasterMobile' || $server['settings'] == 'GreenWebBD' || $server['settings'] == 'HablameV2' || $server['settings'] == 'CaihCom'  || $server['settings'] == 'SpoofSend' || $server['settings'] == 'AlhajSms' || $server['settings'] == 'SendroidUltimate' || $server['settings'] == 'RealSMS' || $server['settings'] == 'Sinch' || $server['settings'] == 'PitchWink')
                                        ...
                                        @if($server['settings'] == 'CMCOM')
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label class="required" for="api_token">Product Token</label>
                                                    <input type="text" id="api_token" class="form-control @error('api_token') is-invalid @enderror" value="{{ $server['api_token'] }}" name="api_token" required>
                                                    @error('api_token')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                        ...
                                        @if($server['settings'] == 'HablameV2' || $server['settings'] == 'GlobalSMSCN')
                                        ...
                                        @if($server['settings'] == 'GlobalSMSCN')
                                        ...
                                        @if($server['settings'] == 'Callr')
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label class="required" for="username">API Login</label>
                                                    <input type="text" id="username" class="form-control @error('username') is-invalid @enderror" value="{{ $server['username'] }}" name="username" required>
                                                    @error('username')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="d-flex justify-content-start flex-wrap col-12">
                                            ...
                                            @if($server['settings'] == 'Twilio' || $server['settings'] == 'TextLocal' || $server['settings'] == 'Plivo' || $server['settings'] == 'PlivoPowerpack' || $server['settings'] == 'SMSGlobal' || $server['settings'] == 'MessageBird' || $server['settings'] == 'WhatsAppChatApi' || $server['settings'] == 'SignalWire' || $server['settings'] == 'Telnyx' || $server['settings'] == 'Bandwidth' || $server['settings'] == 'Skyetel')
                                            ...
                                            @if($server['settings'] == 'Twilio' || $server['settings'] == 'Clickatell_Touch' || $server['settings'] == 'MessageBird' || $server['settings'] == 'WhatsAppChatApi' || $server['settings'] == 'WaApi' )
                                                <div class="custom-control custom-switch switch-lg custom-switch-success mr-2 mb-1">
